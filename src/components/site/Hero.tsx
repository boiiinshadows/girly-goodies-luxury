...
export function Hero() {
  ...
  return (
    <section ref={ref} id="top" className="relative min-h-screen overflow-hidden gradient-luxe">
      ...
      >
        <div className="absolute top-[10%] -left-20 w-[500px] h-[500px] rounded-full bg-blush/40 blur-3xl md:blur-3xl blur-2xl" />
        <div className="absolute bottom-[5%] -right-20 w-[600px] h-[600px] rounded-full bg-champagne/50 blur-3xl md:blur-3xl blur-2xl" />
        <div className="absolute top-[40%] left-[40%] w-[300px] h-[300px] rounded-full bg-rose-gold/20 blur-3xl md:blur-3xl blur-xl" />
      </motion.div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-(--spacing-content-px) pt-32 lg:pt-40 pb-20 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen">
        ...
        >
          <motion.div
            style={{ y: sy }}
            className="absolute inset-0 animate-float will-change-transform"
          >
